...
{\color{red}\Large Be careful ! These notes are outdated. Don't need to read the second part \textit{Application on an one band model} because the new results are very differents.}
